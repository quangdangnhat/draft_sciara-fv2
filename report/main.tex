...
\begin{figure}[H]
\centering
% Upload histogram_times.png to Overleaf and uncomment:
% \includegraphics[width=0.85\textwidth]{histogram_times.png}
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.2cm}\textbf{[Upload histogram\_times.png]}\vspace{1.2cm}}}
...
\begin{figure}[H]
\centering
% Upload roofline_fp64.png to Overleaf and uncomment:
% \includegraphics[width=0.9\textwidth]{roofline_fp64.png}
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.2cm}\textbf{[Upload roofline\_fp64.png]}\vspace{1.2cm}}}
