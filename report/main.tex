...
% Figure: Occupancy comparison chart
\begin{figure}[H]
\centering
% \includegraphics[width=0.8\textwidth]{occupancy_chart.png}
\fbox{\parbox{0.75\textwidth}{\centering\vspace{1.5cm}\texttt{occupancy\_chart.png}\vspace{1.5cm}}}
\caption{Theoretical vs achieved GPU occupancy. CfAMo has lowest occupancy but best performance.}
\label{fig:occupancy}
\end{figure}
